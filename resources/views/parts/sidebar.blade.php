    ...
    <div class="sidebar-nav" data-simplebar="true">
        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              <li><a class="nav-link" href="{{route('category')}}">Add Category</a>
              </li>
              <li><a class="nav-link" href="{{route('category_show')}}">Show Categories</a>
              </li>
            </ul>
        </li>
          <li>
            ...
            <ul>
              <li><a class="nav-link" href="{{route('products.view')}}">Add Product</a>
              </li>
              <li><a class="nav-link" href="{{route('products.show')}}">Show Products</a>
              </li>
            </ul>
          </li>
