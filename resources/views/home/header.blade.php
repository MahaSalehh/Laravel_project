        ...
        <div class="row wrapper-header align-items-center">
            ...
            <div class="col-xl-3 col-md-4 col-3">
                <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                    ...
                    <li class="nav-wishlist"><a href="wishlist.html" class="nav-icon-item"><i class="icon icon-heart"></i></a></li>
                    <li class="nav-cart"><form action="{{ route('show.cart') }}"  style="display: inline;">
                        @csrf
                          ...
                          <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                              ...
                              <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                                  @csrf
                                  <button type="submit" class="nav-link btn btn-link" style="display: inline;">Log Out</button>
                              </form>
                          </li>
                    </ul>
            </div>
