...
@foreach ($cart as $cart)
            ...
            <td>{{$cart->product_title}}</td>
              ...
              {{-- <td><a class="btn btn-danger" href="{{route('remove.cart',$cart->id)}}">Remove</a></td> --}}
              <td><form action="{{ route('remove.cart', ['id' => $cart->id]) }}" method="POST" style="display:inline-block;">
                @csrf
                @method('DELETE')
