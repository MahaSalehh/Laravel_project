        ...
        <header id="header" class="header-default header-absolute">
            <div class="px_15 lg-px_40">
                    ...
                    <div class="col-xl-6 tf-md-hidden">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                <li class="menu-item">
                                    <a href="#" class="item-link">Dashboard<i class="icon icon-arrow-down"></i></a>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="images/demo/dashboard-01.jpg" src="images/demo/dashboard-01.jpg" alt="home-01">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                                <span>Trend</span>
                                                            </div>
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 01</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-multi-brand.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="images/demo/dashboard-multi-brand.jpg" src="images/demo/dashboard-multi-brand.jpg" alt="home-multi-brand">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                                <span class="demo-hot">Hot</span>
                                                            </div>
                                                        </div>
                                                        <span class="demo-name">Dashboard Multi Brand</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-02.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="images/demo/dashboard-02.jpg" src="images/demo/dashboard-02.jpg" alt="home-02">
                                                            <div class="demo-label">
                                                                <span class="demo-hot">Hot</span>
                                                            </div>
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 02</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-03.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-03.jpg" src="images/demo/dashboard-03.jpg" alt="home-03">
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 03</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-04.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-04.jpg" src="images/demo/dashboard-04.jpg" alt="home-04">
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 04</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-05.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-05.jpg" src="images/demo/dashboard-05.jpg" alt="home-05">
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 05</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-06.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="images/demo/dashboard-06.jpg" src="images/demo/dashboard-06.jpg" alt="home-06">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                            </div>
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 06</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-07.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-07.jpg" src="images/demo/dashboard-07.jpg" alt="home-07">
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 07</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-08.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-08.jpg" src="images/demo/dashboard-08.jpg" alt="home-08">
                                                        </div>
                                                        <span class="demo-name">Dashboard Fashion 08</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-skincare.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-skincare.jpg" src="images/demo/dashboard-skincare.jpg" alt="home-skincare">
                                                        </div>
                                                        <span class="demo-name">Dashboard Skincare</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-headphone.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-headphone.jpg" src="images/demo/dashboard-headphone.jpg" alt="home-headphone">
                                                        </div>
                                                        <span class="demo-name">Dashboard Headphone</span>
                                                    </a>
                                                </div>
                                                <div class="demo-item">
                                                    <a href="home-giftcard.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="images/demo/dashboard-giftcard.jpg" src="images/demo/dashboard-giftcard.jpg" alt="home-gift-card">
                                                        </div>
                                                        <span class="demo-name">Dashboard Gift Card</span>
                                                    </a>
                                                </div>
                                            </div>
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Hello {{ Auth::user()->name }}</a>
                        @else
                        <h6><b><a href="{{ route('login') }}" class=" text-gray-600 hover:text-gray-900 ">Login</a></b></h6>
                        @if (Route::has('register'))
                            <h6><a href="{{ route('register') }}" class="text-gray-600 hover:text-gray-900 ">Register</a></h6>
                        @endif
                    @endauth
                    ...
                    <div class="row-demo">
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-furniture.jpg" src="images/demo/dashboard-furniture.jpg" alt="home-furniture">
                                </div>
                                <span class="demo-name">Dashboard Furniture</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-furniture2.jpg" src="images/demo/dashboard-furniture2.jpg" alt="home-furniture-2">
                                </div>
                                <span class="demo-name">Dashboard Furniture 2</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-skateboard.jpg" src="images/demo/dashboard-skateboard.jpg" alt="home-skateboard">
                                </div>
                                <span class="demo-name">Dashboard Skateboard</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-stroller.jpg" src="images/demo/dashboard-stroller.jpg" alt="home-stroller">
                                </div>
                                <span class="demo-name">Dashboard Stroller</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-decor.jpg" src="images/demo/dashboard-decor.jpg" alt="home-decor">
                                </div>
                                <span class="demo-name">Dashboard Decor</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-electronic.jpg" src="images/demo/dashboard-electronic.jpg" alt="home-electronic">
                                </div>
                                <span class="demo-name">Dashboard Electronic</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-setup-gear.jpg" src="images/demo/dashboard-setup-gear.jpg" alt="home-setup-gear">
                                </div>
                                <span class="demo-name">Dashboard Setup Gear</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-dog-accessories.jpg" src="images/demo/dashboard-dog-accessories.jpg" alt="home-dog-accessories">
                                </div>
                                <span class="demo-name">Dashboard Dog Accessories</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-kitchen.jpg" src="images/demo/dashboard-kitchen.jpg" alt="home-kitchen-wear">
                                </div>
                                <span class="demo-name">Dashboard Kitchen Wear</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-phonecase.jpg" src="images/demo/dashboard-phonecase.jpg" alt="home-phonecase">
                                </div>
                                <span class="demo-name">Dashboard Phonecase</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard_paddle_board.jpg" src="images/demo/dashboard_paddle_board.jpg" alt="home-paddle_board">
                                </div>
                                <span class="demo-name">Dashboard Paddle Boards</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-glasses.jpg" src="images/demo/dashboard-glasses.jpg" alt="home-glasses">
                                </div>
                                <span class="demo-name">Dashboard Glasses</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-pod-store.jpg" src="images/demo/dashboard-pod-store.jpg" alt="home-pod-store">
                                </div>
                                <span class="demo-name">Dashboard POD Store</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-activewear.jpg" src="images/demo/dashboard-activewear.jpg" alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-handbag.jpg" src="images/demo/dashboard-handbag.jpg" alt="home-handbag">
                                </div>
                                <span class="demo-name">Dashboard Handbag</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-tee.jpg" src="images/demo/dashboard-tee.jpg" alt="home-tee">
                                </div>
                                <span class="demo-name">Dashboard Tee</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-socks.jpg" src="images/demo/dashboard-socks.jpg" alt="home-sock">
                                </div>
                                <span class="demo-name">Dashboard Sock</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-jewelry.jpg" src="images/demo/dashboard-jewelry.jpg" alt="home-jewelry">
                                </div>
                                <span class="demo-name">Dashboard Jewelry</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-sneaker.jpg" src="images/demo/dashboard-sneaker.jpg" alt="home-sneaker">
                                </div>
                                <span class="demo-name">Dashboard Sneaker</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-accessories.jpg" src="images/demo/dashboard-accessories.jpg" alt="home-accessories">
                                </div>
                                <span class="demo-name">Dashboard Accessories</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-grocery.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-gocery.jpg" src="images/demo/dashboard-gocery.jpg" alt="home-grocery">
                                </div>
                                <span class="demo-name">Dashboard Grocery</span>
                            </a>
                        </div>
                        <div class="demo-item">
                            <a href="home-baby.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="images/demo/dashboard-baby.jpg" src="images/demo/dashboard-baby.jpg" alt="home-baby">
                                </div>
                                <span class="demo-name">Dashboard Baby</span>
                            </a>
                        </div>
                    ...
                    <li class="nav-mb-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse">
                            <ul class="sub-nav-menu" >
                                <li><a href="index.html" class="sub-nav-link">Dashboard Fashion 01</a></li>
                                <li><a href="home-02.html" class="sub-nav-link">Dashboard Fashion 02</a></li>
                                <li><a href="home-03.html" class="sub-nav-link">Dashboard Fashion 03</a></li>
                                <li><a href="home-04.html" class="sub-nav-link">Dashboard Fashion 04</a></li>
                                <li><a href="home-05.html" class="sub-nav-link">Dashboard Fashion 05</a></li>
                                <li><a href="home-06.html" class="sub-nav-link">Dashboard Fashion 06</a></li>
                                <li><a href="home-07.html" class="sub-nav-link">Dashboard Fashion 07</a></li>
                                <li><a href="home-08.html" class="sub-nav-link">Dashboard Fashion 08</a></li>
                                <li><a href="home-giftcard.html" class="sub-nav-link">Dashboard Gift Card</a></li>
                                <li><a href="home-headphone.html" class="sub-nav-link">Dashboard Headphone</a></li>
                                <li><a href="home-multi-brand.html" class="sub-nav-link">Dashboard Multi Brand</a></li>
                                <li><a href="home-skincare.html" class="sub-nav-link">Dashboard skincare</a></li>
                                <li><a href="home-headphone.html" class="sub-nav-link">Dashboard Headphone</a></li>
                                <li><a href="home-giftcard.html" class="sub-nav-link">Dashboard Gift Card</a></li>
                                <li><a href="home-furniture.html" class="sub-nav-link">Dashboard Furniture</a></li>
                                <li><a href="home-furniture-02.html" class="sub-nav-link">Dashboard Furniture 2</a></li>
                                <li><a href="home-skateboard.html" class="sub-nav-link">Dashboard Skateboard</a></li>
                                <li><a href="home-stroller.html" class="sub-nav-link">Dashboard Stroller</a></li>
                                <li><a href="home-decor.html" class="sub-nav-link">Dashboard Decor</a></li>
                                <li><a href="home-electronic.html" class="sub-nav-link">Dashboard Electronic</a></li>
                                <li><a href="home-setup-gear.html" class="sub-nav-link">Dashboard Setup Gear</a></li>
                                <li><a href="home-dog-accessories.html" class="sub-nav-link">Dashboard Dog Accessories</a></li>
                                <li><a href="home-kitchen-wear.html" class="sub-nav-link">Dashboard Kitchen Wear</a></li>
                                <li><a href="home-phonecase.html" class="sub-nav-link">Dashboard Phonecase</a></li>
                                <li><a href="home-paddle-boards.html" class="sub-nav-link">Dashboard Paddle Boards</a></li>
                                <li><a href="home-glasses.html" class="sub-nav-link">Dashboard Glasses</a></li>
                                <li><a href="home-pod-store.html" class="sub-nav-link">Dashboard POD Store</a></li>
                                <li><a href="home-activewear.html" class="sub-nav-link">Dashboard Activewear</a></li>
                                <li><a href="home-handbag.html" class="sub-nav-link">Dashboard Handbag</a></li>
                                <li><a href="home-tee.html" class="sub-nav-link">Dashboard Tee</a></li>
                                <li><a href="home-sock.html" class="sub-nav-link">Dashboard Sock</a></li>
                                <li><a href="home-jewerly.html" class="sub-nav-link">Dashboard Jewelry</a></li>
                                <li><a href="home-sneaker.html" class="sub-nav-link">Dashboard Sneaker</a></li>
                                <li><a href="home-accessories.html" class="sub-nav-link">Dashboard Accessories</a></li>
                                <li><a href="home-grocery.html" class="sub-nav-link">Dashboard Grocery</a></li>
                                <li><a href="home-baby.html" class="sub-nav-link">Dashboard Baby</a></li>
                            </ul>
                        </div>
